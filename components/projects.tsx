...
const projects = [
  {
    num: "01",
    name: "MandviCart",
    description: "Full-featured e-commerce platform with shopping cart functionality, product catalog, and modern UI. Built with React for seamless shopping experience and intuitive navigation.",
    tags: ["React", "E-commerce", "Shopping Cart", "Responsive Design"],
    image: "/api/placeholder/600/400",
    github: "https://github.com/ParthDevOp/MandviCart",
    live: "https://mandvi-cart.vercel.app/home",
    featured: true,
  },
  {
    num: "02",
    name: "QuickShow",
    description: "Movie ticket booking application inspired by BookMyShow. Features city selection, theater listings, movie browsing, and seat booking. Built with modern web technologies for smooth user experience.",
    tags: ["React", "Movie Booking", "API Integration", "Responsive UI"],
    image: "/api/placeholder/600/400",
    github: "https://github.com/ParthDevOp/QuickShow",
    live: "https://quick-show-gilt-pi.vercel.app/",
    featured: true,
  },
  {
    num: "03",
